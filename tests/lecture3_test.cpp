...
TEST(L3, vanillaCallPayOffs)
{
    ...
    EXPECT_EQ(callOp.Payoff(strike+13.3), strike+13.3-strike) << "Vanilla call ITM case failed!";
    EXPECT_EQ(callOp.Payoff(strike), 0.0) << "Vanilla call ITM case failed!";
    EXPECT_EQ(callOp.Payoff(strike/2.0), 0.0) << "Vanilla call ITM case failed!";
}
...
TEST(L3, vanillaPutPayOffs)
{
    ...
    EXPECT_EQ(putOp.Payoff(strike/3.1), strike-strike/3.1) << "Vanilla call ITM case failed!";
    EXPECT_EQ(putOp.Payoff(strike), 0.0) << "Vanilla call ITM case failed!";
    EXPECT_EQ(putOp.Payoff(strike*2.0), 0.0) << "Vanilla call ITM case failed!";
}
