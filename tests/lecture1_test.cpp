...
TEST(L1, vanillaCallPayOffs) {
    EXPECT_EQ(lecture1::CallPayoff(10.1, 2.1), 8.0)
        << "Vanilla call ITM case failed!";
    EXPECT_EQ(lecture1::CallPayoff(2.3, 10.4), 0.0)
        << "Vanilla call OTM case failed!";
    EXPECT_EQ(lecture1::CallPayoff(100.2, 100.2), 0.0)
        << "Vanilla call ATM case failed!";
}

TEST(L1, vanillaPutPayOffs) {
    EXPECT_EQ(lecture1::PutPayoff(10.1, 2.1), 0.0)
        << "Vanilla put OTM case failed!";
    EXPECT_EQ(lecture1::PutPayoff(2.3, 10.4), 10.4 - 2.3)
        << "Vanilla put ITM case failed!";
    EXPECT_EQ(lecture1::PutPayoff(100.2, 100.2), 0.0)
