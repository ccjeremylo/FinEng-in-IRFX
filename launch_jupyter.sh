echo "Launch jupyter from src folder"

while true; do
    read -p "Have you successfully deployed the c++ package? [y/n]: " yn
    case $yn in
        [Yy]* ) "Great! We will procceed."; break;;
        [Nn]* ) "Program terminated - please run ./deploy_cpp_module.sh"; exit;;
...
while true; do
    ...
    case $yn in
        [Nn]* ) "Great! We can skip all installation."; break;;
