...
double lecture2::d_j(const int& j, const double& S, const double& K,
...
double lecture2::call_price(const double& S, const double& K, const double& r,
...
double lecture2::put_price(const double& S, const double& K, const double& r,
                           const double& v, const double& T) {
    return -S * lecture2::norm_cdf(-d_j(1, S, K, r, v, T)) +
           K * exp(-r * T) *
               lecture2::norm_cdf(-lecture2::d_j(2, S, K, r, v, T));
